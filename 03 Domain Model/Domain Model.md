...
UI Shell과 Primary Personal Server의 application service를 연결하는 통신 경계. MVP는 localhost HTTP API를 우선하며, 향후 Desktop App에서는 같은 HTTP API 또는 local IPC를 사용할 수 있다. Local Transport는 Internal Tool Contract 자체가 아니다.
