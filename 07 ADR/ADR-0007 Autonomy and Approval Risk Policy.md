...
Personal Mode:
Personal Mode risk handling is governed by the user's active approval mode and authority envelope. Full access or Custom may grant broad local authority. The platform records actions and applies explicit restrictions; it does not replace Owner judgment.

Team Mode:
Team Mode risk handling will be governed by central server / organization policy. (Detailed Team Mode policies will be designed later.)
