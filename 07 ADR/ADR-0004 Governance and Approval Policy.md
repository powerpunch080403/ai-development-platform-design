...
이 결정은 [[07 ADR/ADR-0001 Central Authority]], [[07 ADR/ADR-0002 Personal Owner]], [[06 Security/Identity and Approval]]의 권한 분리 원칙을 확장한다.
...
구체적인 위험도 단계, 승인 인원 수, 승격 규칙은 이 ADR에서 확정하지 않는다.
